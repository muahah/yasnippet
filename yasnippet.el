...
(defun yas--indent-region (from to snippet)
  "Indent from FROM to TO with `indent-according-to-mode'  SNIPPET's markers."
  ...
  ;; After indentation takes place we should be at the correct to
  ;; restore them to. All other non-trouble-markers should have been
  ;; *pushed* and don't need special attention.
  ;;
  ...
  (save-excursion
    (dolist (field-and-mirror (sort
      ...
      (let* ((field (car field-and-mirror))
        ...
        ;; protected overlays might been changed because of insertions
